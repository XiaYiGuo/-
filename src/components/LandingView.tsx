  ...
  return (
    ...
    >
      <header className="mb-16 text-center">
        <h2 className="text-4xl font-serif leading-tight  border-b-2 border-black inline-block pb-4 mb-4">
          AI数据服务场景
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <h3 className="text-2xl font-serif  font-bold mb-4 text-[#1A1A1A]">核心业务事项核验</h3>
        ...
        >
          ...
          <h3 className="text-2xl font-serif  font-bold mb-4 text-[#1A1A1A]">数据目录质量核验</h3>
          <p className="text-sm text-gray-500 text-center leading-relaxed">
